...
<nav class="navbar navbar-top fixed-top bg-primary text-white">
    <div class="container">
        ...
        <a class="d-inline navbar-brand text-white" href="#">
            ...
            <img src="<?php echo e(asset('images/logo-dashboard.png')); ?>" alt="Logo" width="32" class="align-text-bottom me-2">
            
            <span class="fs-4 text-uppercase">Apotek Nusantara</span>
        </a>
    </div>
</nav>
...
</nav><?php /**PATH D:\laragon\www\Pustaka-Koding\Project-Laravel\Laravel-11\aplikasi-pos-apotek-laravel11\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>