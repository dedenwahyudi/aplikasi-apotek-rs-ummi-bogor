...
<?php endif; ?>
    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-4">
        <div class="row">
            <div class="d-grid d-lg-block col-lg-5 col-xl-6 mb-4 mb-lg-0">
                ...
                <a href="<?php echo e(route('categories.create')); ?>" class="btn btn-primary py-2 px-3">
            ...
            <div class="col-lg-7 col-xl-6">
                ...
                <form action="<?php echo e(route('categories.index')); ?>" method="GET">
                    <div class="input-group">
                        <input type="text" name="search" class="form-control form-search py-2" value="<?php echo e(request('search')); ?>" placeholder="Search category ..." autocomplete="off">
    ...
    <div class="bg-white rounded-2 shadow-sm pt-4 px-4 pb-3 mb-5">
            ...
            <table class="table table-bordered table-striped table-hover" style="width:100%">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td width="200"><?php echo e($category->name); ?></td>
                        <td width="70" class="text-center">
                            
                            <a href="<?php echo e(route('categories.edit', $category->id)); ?>" class="btn btn-primary btn-sm m-1" data-bs-tooltip="tooltip" data-bs-title="Edit">
                                <i class="ti ti-edit"></i>
                            </a>
                            
                            <button type="button" class="btn btn-danger btn-sm m-1" data-bs-toggle="modal" data-bs-target="#modalDelete<?php echo e($category->id); ?>" data-bs-tooltip="tooltip" data-bs-title="Delete"> 
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <p class="mb-2">
                                        Are you sure to delete <span class="fw-bold mb-2"><?php echo e($category->name); ?></span>?
                                    </p>
                                </div>
        ...
        <div class="pagination-links"><?php echo e($categories->links()); ?></div>
    </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\Pustaka-Koding\Project-Laravel\Laravel-11\aplikasi-pos-apotek-laravel11\resources\views/categories/index.blade.php ENDPATH**/ ?>