...
<?php endif; ?>
<?php $component->withAttributes([]); ?>Edit Transaction <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('date', $transaction->date)); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" autocomplete="off">
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e(old('customer', $transaction->customer_id) == $customer->id ? 'selected' : ''); ?> value="<?php echo e($customer->id); ?>"><?php echo e($customer->name); ?></option>
...
unset($__errorArgs, $__bag); ?>" autocomplete="off">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option <?php echo e(old('product', $transaction->product_id) == $product->id ? 'selected' : ''); ?> value="<?php echo e($product->id); ?>" data-price="<?php echo e(number_format($product->price, 0, '', '.')); ?>"><?php echo e($product->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('price', number_format($transaction->product->price, 0, '', '.'))); ?>" readonly>
                        </div>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('qty', $transaction->qty)); ?>" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('total', number_format($transaction->total, 0, '', '.'))); ?>" readonly>
                        </div>
...
<?php endif; ?><?php /**PATH D:\laragon\www\Pustaka-Koding\Project-Laravel\Laravel-11\aplikasi-pos-apotek-laravel11\resources\views/transactions/edit.blade.php ENDPATH**/ ?>