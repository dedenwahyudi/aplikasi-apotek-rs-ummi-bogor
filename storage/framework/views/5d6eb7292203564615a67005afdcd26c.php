...
<?php endif; ?>
    ...
    <div class="bg-white rounded-2 shadow-sm p-4 mb-5">
        <div class="row align-items-center g-5">
            <div class="col-lg-3">
                <img src="<?php echo e(asset('images/img-dashboard.svg')); ?>" class="img-fluid opacity-85" alt="images" loading="lazy">
            </div>
            <div class="col-lg-9">
                <h4 class="text-primary mb-2">
                    Selamat datang di <span class="fw-semibold">Pustaka Koding</span>!
                </h4>
                <p class="lead-dashboard mb-4">Pustaka Koding merupakan platform belajar koding online yang akan membantu mengembangkan skill koding Kamu dengan belajar melalui beragam studi kasus pembuatan aplikasi yang dapat dipraktekan secara langsung.</p>
                <div class="d-grid gap-3 d-md-flex justify-content-md-start">
                    <a href="https://pustakakoding.com/" target="_blank" class="btn btn-primary py-2 px-4">
...
<?php endif; ?><?php /**PATH D:\laragon\www\Pustaka-Koding\Project-Laravel\Laravel-11\aplikasi-pos-apotek-laravel11\resources\views/dashboard/index.blade.php ENDPATH**/ ?>